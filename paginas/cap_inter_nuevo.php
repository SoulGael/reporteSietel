...
$proved=$_POST['proved'];
	...
	if(pg_query("insert into tbl_capacidad_inter (nodo_princ, provincia, ciudad, capacidad_interup, capacidad_interdown, proveedor) 
		values('".$ciudad."','".$provincia."','".$ciudad."','".$up."','".$down."','".$proved."')"))
	{
		echo "<td colspan='5'><div class='alert alert-success'>Guardado Correctamente</div></td>";
	}
	else
	{
	echo "<td colspan='5'><div class='alert alert-danger'>No se pudo Guardar Intentelo Nuevamente</div></td>";
	}
